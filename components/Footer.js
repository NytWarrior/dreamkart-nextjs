    ...
    return (
        <div>
            <footer className="text-gray-600 body-font">
                <div class="container px-10 py-18 mx-auto flex items-center md:flex-row flex-col">
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 DreamKart —
                            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@dreamkart</a>
                        </p>
