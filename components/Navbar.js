    ...
    return (
        <header className="text-gray-600 body-font sticky top-0 z-10 bg-white">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <a href={'/signin'} className="inline-flex items-center px-2 bg-gray-100 border-0 focus:outline-none text-base mt-4 md:mt-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
            ...
            <div ref={ref} className="w-72 h-[100vh] sideCart absolute top-0 right-0 bg-indigo-100 px-8 py-10 transform transition-transform translate-x-full">
                ...
                <div className='flex'>
                    <Link href={'/checkout'} className='flex mr-2 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded text-sm'>
