...
export default async function handler(req, res) {
    ...
    if (req.body.sendEmail) {
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                                    ...
                                    <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                                        ...
                                        We have sent you this email in response to your request to reset your password on Dreamkart.
                                        ...
                                        We recommend that you keep your password secure and not share it with anyone.If you feel your password has been compromised, you can change it by going to your Dreamkart - My Account Page and change your password.
        ...
        const mailOptions = {
            ...
            to: req.body.email,
            subject: "Reset Dreamkart password",
            html: emailHtml,
        };
